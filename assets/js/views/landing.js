define([
	...
	var LandingView = Backbone.View.extend({
		...
		firstblock: ['<div style="margin:2%;">',
			...
			'<tr>',
			'<td colspan="2"><div class="v1-11 c2"><span>Arte</span></div></td>',
			'<td><div class="v1-13 c1"><span>Maratón</span></div></td>',
			'</tr>',
			'<tr>',
			'<td width="33%"><div class="v1-15 c1"><span>Jardinería</span></div></td>',
			'<td width="33%"><div class="v1-17 c1" ><span>Cocina</span></div></td>',
			'<td width="33%"><div class="v1-14 c1"><span>Ballet</span></div></td>',
			'</tr>',
			'<tr>',
			'<td><div class="v1-16 c1"><span>Piano</span></div></td>',
			'<td colspan="2"><div class="v1-12 c2"><span>Bicicleta</span></div></td>',
			'</tr>',
			'</table>',
			'</div>'
		].join(''),
		...
		secondblock: ['<div class="row secondblock" style="margin:2%;">',
			'<div class="col-sm-5 col-xs-12" style="text-align:center;border-right:2px solid">',
			'<h3>Aprende con un</h3>',
			'<h2>CRAACK</h2>',
			'<h2><small>y serás un</small><h2>',
			'<h2>CRAACK</h2>',
			'</div>',
			'<div class="col-sm-7 col-xs-12" style="text-align:left;">',
		...
		lastblock: ['<div style="margin:2%;min-height: 500px;">',
			...
			'<div class="ticket col-sm-5 col-xs-11">',
