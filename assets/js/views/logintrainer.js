define([
	...
	var LoginTrainerView = Backbone.View.extend({
		...
		content: [
			'<div class="modal" id="logintrainer" tabindex="-1" role="dialog" aria-labelledby="loginuserLabel" aria-hidden="true">',
			...
			'<form role="form" class="form-inline" id="formlogintrainer">',
			...
			'<input type="text" class="form-control inputname" id="logintrainerInputName" placeholder="nombre">',
			'</div>',
			'</div>',
			...
			'<input type="email" class="form-control inputemail" id="logintrainerInputEmail1" placeholder="email">',
			'</div>',
			'</div>',
			...
			'<input type="celular" class="form-control inputcelular" id="logintrainerInputCelular" placeholder="celular">',
			'</div>',
			'</div>',
